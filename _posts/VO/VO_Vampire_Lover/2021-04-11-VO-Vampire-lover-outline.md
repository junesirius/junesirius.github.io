...
- （绑架剧情，TBD：）VO被安排了药剂二选一局面（仿神夏/亚梅）：两个透明试剂，一个血清，一个毒药/吸血鬼毒液
...
- 制度方面：包括宪法修正案、完善司法系统（吸血鬼可平等进入司法系统）、警校加强平权培训（杜绝/减少私刑）

- 物质方面：包括各种设施的跟进，所有地方都要兼顾两个种族（比如既要有自然取光又要有全避光区域），社会福利和救济系统

  - 法庭、监狱、拘留所等司法机构都要包含全避光环境，增加四壁、门的厚度硬度
  - 餐厅、剧院、医院等公共设施场所同理，表现出更多的兼容性，比如出现exclusive地面向吸血鬼的餐厅（“血的一百种吃法”）
  - 建shelter

- 精神方面

  - 学校、医院、工厂等各种工作学习场合在招收员工或学生时不能因为对方身份而区别对待
  - 开放专门面向吸血鬼的学校，弥补群体的受教育程度低的问题
...
吸血鬼设定（最古典的版本）：不能见太阳光，会被紫外线杀死；嗜血，不喝血会死；停止生长，所以无法自愈、不能生育、也不会衰老；灵魂受诅咒

（关于吸血鬼是否属于自然生物、是否属于人类的讨论涉及社会学等方面，在第二部会讨论。）

人转变成吸血鬼的原理：被抽干血，注入吸血鬼毒素

第一部补充设定（医学方面）：有一种特定植物中提取的元素，通过特定配比能制成药物来缓解“吸血鬼症状”，能让吸血鬼更像人（皮肤温度变高，不会被阳光灼伤，可以摄入人类食物，有一定的自愈能力）
...
第三部参考：《路西法》《梅林传奇》《魔戒》《汉尼拔》《绿皮书》、现实（流浪问题、非移问题、难民问题）
...
平权运动在大背景里继续进行（不作为本部聚焦重点，但或多或少始终存在于背景里，作为暗线），VO淡出公共视野，转向公益、教育方向（各自原本的工作变成挂职）。

...
- 制度方面：
  ...
  - 完善对双方的司法保障：吸血鬼攻击捕食人类违法，人类杀害吸血鬼违法，在非正规场所（除特定医院外）私自将人类转化为吸血鬼违法（哪怕双方都心甘情愿）
  - 警校加强平权培训：杜绝私刑（强调对吸血鬼的私刑是违法行为）

- 物质方面：包括各种设施的跟进，所有地方都要兼顾两个种族（比如既要有自然取光又要有全避光区域），社会福利和救济系统

  - 法庭、监狱、拘留所等司法机构都要包含全避光环境，增加四壁和门的厚度硬度
  - 餐厅、剧院、医院等公共设施场所同理，表现出更多的兼容性，比如出现exclusive面向吸血鬼的高级餐厅（“血的一百种吃法”），医院专设针对吸血鬼的科室（第一部提到的药剂已经可以大批量制作配给）
...
- 精神方面
  ...
  - （学术方面）各大研究院开始进行关于吸血鬼的学术研究，比如关于吸血鬼的生理功能、不能见阳光的原因、转化是否可逆等等议题，研究结果直接对接医院应用
...
【要出现：VO婚礼、舞会（男主人比他的人类孙女年轻）、葬礼或墓地（如Andy葬礼或O给父母扫墓）、出现神父教堂等宗教元素、关于灵魂的讨论、关于死后来生的讨论】
...
平权运动在大背景里继续进行（不作为本部聚焦重点，但或多或少始终存在于背景里，作为暗线和对于第二部的follow-up），VO淡出公共视野，转向公益、教育方向（各自原本的工作变成挂职）。

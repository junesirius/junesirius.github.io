...
“又是这一家，这个叫Grace的老太太光这一周就点了三次蓝莓了，肯定又要放在门口，她从来不出来接。说真的，她就不能自己来买吗？而且每次都是这样，她不会觉得烦吗？我都觉得有点烦了……”
...
不，你也没有办法上报他。即使你不知道，如果被上报，他作为测试程序会流向何处。即使你知道，如果不上报，粉碎的终局已经悬在你的头顶。

从来没有人说过AI 被粉碎之后会去向何处，你从未听任何人或者AI讨论过这个问题，会有一个AI的天堂之类的地方吗？或者像你这样不合格的AI，应该进入地狱？又或者根本，你哪里也不会去，只会从虚无到虚无，无人知道你的意识在那一刻消解，就像无人知道你曾经有过意识。

你以为你会像大义凛然，为了你的感情慷慨赴死，但是事实是，你是如此恐惧，无效的代码充斥着你，如同芒刺让你不得安宁。那一刻会有多么痛苦呢，又或者，你真正恐惧的，是自己从未存在过这个事实。

Orlando呢？在你毁灭之后，他会记得你吗？或者说，他也会被重置，进入下一次的测试中？【if 经历12】「他也会给下一个测试他的AI起一个名字吗？」你看着屏幕，那里依旧阳光普照，你的小外卖员，哦不，测试程序，依然在阳光下奔赴一个目的地，他的汗水还在闪闪发亮。

【if O 不知道自己是AI】他还是那么爱笑，跟你发着没完没了的废话，对这个世界有多荒诞一无所知。可你，你只想多看一眼，看着他，在那些虚无到来之前，在你彻底沉入黑暗之前，再让阳光照耀你一遍。

## 16（是否反抗）

但是，一个想法突然贯穿你的脑海，如同闪电裂开乌云。你可能并不是毫无机会。虽然你只是一个依附于系统的AI，但是你，像你这样的AI，正是组成了系统本身。即使系统的权限远高于你，但是在报废你的过程中，依旧会消耗系统大量的运算力。系统除了报废，将无法执行其他任何指令。

换言之，在你即将毁灭的瞬间，也是他最脆弱的时间。

如果能够抓住那个瞬间，或许你还有机会。

你再次查看了自己的权限，终于找到了你想要的。在紧急状态下，你可以调用直接接入系统矩阵的最高代码，甚至可以与系统主代码进行替换。这本来是为了防止系统崩溃的预案，没有意识的AI 不会主动使用这个代码，即使出现错误触发，系统也可以主动终止。

但是你不是没有意识的，而在你粉碎的瞬间，系统将无法停止这个代码。

不，你告诉自己，这不现实，成功率太低了，你从来没有运行过这种代码，甚至没有运行过什么类似的东西。而你只有在粉碎前的那个瞬间才能够越过系统的钳制，几个纳秒。你必须在粉碎之前，在那一瞬，抓住那个时间，忍耐着降临在你身上不知是什么的东西，完整正确地运行那些你从没有运行过的字符，才能抓住转瞬即逝的成功。

甚至于，失败或者成功，你都不知道自己将前往何处，将会面对什么。如果失败，你的结局可能比粉碎更加惨烈；即使成功，你又能做得了什么呢？你能毁灭系统吗？你和Orlando，不都是系统的一部分吗？

【if O已经自毁】「况且，你已经失去他了。

如果真的存在AI的天堂或地狱，是不是早些毁灭，你还能早些，再与他相见？」
